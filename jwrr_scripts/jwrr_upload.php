...
function jwrr_upload_form($atts = array(), $content = null, $tag = '')
{
  ...
  $upload_handler = "${home_page_uri}upload_request.php";
  $enable_style = false;
...
// add_shortcode('jwrr_upload_request', 'jwrr_upload_request');

function jwrr_upload_request()
{

  if (!jwrr_session_is_signed_in()) return "";
...
exec($tile, $exec_output, $exec_retval);
       ...
       $home_page_uri = get_home_page_uri();
       $username = jwrr_session_username();
       $basename_of_image = basename($orig_full_filename, '.jpg');
       $path_to_new_page = "${home_page_uri}show.php/b/$username/$basename_of_image";
       header("location: ${home_page_uri}show.php/b/$username/$basename_of_image");
       return $html;
    }
  }
  return "";
